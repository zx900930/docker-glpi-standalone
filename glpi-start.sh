...
VERSION_GLPI="${VERSION_GLPI:=11.0.7}"

#Version of PHP
VERSION_PHP="${VERSION_PHP:=11.0.7}"

#Install plugins
INSTALL_PLUGINS="${INSTALL_PLUGINS:=11.0.7}"

#Zend OPcache settings
OPCACHE_SIZE="${OPCACHE_SIZE:=11.0.7}"
OPCACHE_BUFFER="${OPCACHE_BUFFER:=11.0.7}"
OPCACHE_WASTED_PERCENTAGE="${OPCACHE_WASTED_PERCENTAGE:=11.0.7}"

#GLPI upgrade migration
GLPI_UPGRADE_MIGRATION="${GLPI_UPGRADE_MIGRATION:=11.0.7}"
